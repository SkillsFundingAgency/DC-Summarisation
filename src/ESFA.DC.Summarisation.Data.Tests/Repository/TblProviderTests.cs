...
namespace ESFA.DC.Summarisation.Data.Tests.Repository
{
    public class TblProviderTests
    {
        ...
        public async Task ProvideUkprnsAsync_Check()
        {
            ...
            var mockILRContext = new Mock<IIlr1819RulebaseContext>();
            mockILRContext
        ...
        public async Task ProvideAsync_UKPRNNotFoundCheck()
        {
            ...
            var result = await this.NewProvider(() => mockILRContext.Object).ProvideAsync(ukprn, CancellationToken.None);
            result.Count().Should().Be(0);
            result.Should().BeNullOrEmpty();
        }
        ...
        private TblProvider NewProvider(Func<IIlr1819RulebaseContext> ilrContext = null)
        {
