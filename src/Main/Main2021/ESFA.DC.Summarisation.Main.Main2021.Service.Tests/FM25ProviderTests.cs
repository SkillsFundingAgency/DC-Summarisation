...
namespace ESFA.DC.Summarisation.Main2021.Service.Tests
{
    public class FM25ProviderTests
    {
        ...
        {
            NewProvider().CollectionType.Should().Be("ILR2021");
        }

        [Fact]
        public void CollectionType_CheckWithConstantValue()
        {
            NewProvider().CollectionType.Should().Be(CollectionTypeConstants.ILR2021);
        }
        ...
        public async Task ProvideUkprnsAsync_Check()
        {
            ...
            var ilr2021ContextMock = new Mock<IIlr2021Context>();
            ilr2021ContextMock
        ...
        public async Task ProvideAsync_CheckEmpty()
        {
            ...
            var ilrContextMock = new Mock<IIlr2021Context>();
            ilrContextMock
                .Setup(x => x.FM25_Learners)
                .Returns(FM25Learners.Object);
